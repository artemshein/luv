...
return Object:extend{
	...
	select = function (self, ...) return self.Select(self, ...) end,
	selectRow = function (self, ...) return self.SelectRow(self, ...) end,
	selectCell = function (self, ...) return self.SelectCell(self, ...) end,
	insert = function (self, ...) return self.Insert(self, ...) end,
	insertRow = function (self, ...) return self.InsertRow(self, ...) end,
	update = function (self, ...) return self.Update(self, ...) end,
	updateRow = function (self, ...) return self.UpdateRow(self, ...) end,
	delete = function (self, ...) return self.Delete(self, ...) end,
	deleteRow = function (self, ...) return self.DeleteRow(self, ...) end,
	createTable = function (self, ...) return self.CreateTable(self, ...) end,
	dropTable = function (self, ...) return self.DropTable(self, ...) end
}
